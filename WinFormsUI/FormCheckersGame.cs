...
namespace WinFormsUI
{
    public partial class FormCheckersGame : Form
    {
        ...
        {
            int cellSize = i_BoardSize == 6 ? 90 : i_BoardSize == 8 ? 70 : 56;
            int rowMark = 1;
            char colMark = 'A';
        ...
        private void addNewCellToBoard(int i_Row, int i_Col, int i_CellSize)
        {
            ...
            {
                BackgroundImage = (Math.Abs(i_Row - i_Col)) % 2 == 0
        ...
        private void fitScreenSizeToBoardSize(int i_Size, int i_CellSize)
        {
            ...
            this.Size = new Size(panelBoard.Width + 100, panelBoard.Height + 120);
